...
"border-radius: 10px;")
    ...
    def add_movie(self):
        ...
        response = requests.get(url, params= {"title" : title, 'date' : date, 'price' : price})
...
"border-radius: 10px;")
        ...
        self.log_out.setGeometry(QtCore.QRect(10, 710, 221, 55))
        font = QtGui.QFont()
        font.setPointSize(-1)
...
"")
        ...
        self.log_out.clicked.connect(self.log_out_func)
...
"border-radius: 10px;")
        ...
        self.log_out = QtWidgets.QPushButton(self)
        self.log_out.setGeometry(QtCore.QRect(10, 710, 221, 55))
        font = QtGui.QFont()
        font.setPointSize(-1)
        self.log_out.setFont(font)
