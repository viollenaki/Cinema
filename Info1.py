...
# Form implementation generated from reading ui file 'Info1.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_4.setGeometry(QtCore.QRect(8, 105, 126, 33))
        font = QtGui.QFont()
...
"border-radius: 10px;")
        ...
        self.people_quantity = QtWidgets.QLineEdit(Dialog)
        self.people_quantity.setGeometry(QtCore.QRect(146, 105, 146, 33))
        self.people_quantity.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius: 10px;")
        self.people_quantity.setObjectName("people_quantity")
